...
"""
    ipfp_old(joint_probability::Array{Float64}, marginals; iterations::Integer = 10) -> EMResult
...
```
"""
function ipfp_old(joint_probability::Array{<:AbstractFloat}, marginals; iterations = 10)::EMResult
